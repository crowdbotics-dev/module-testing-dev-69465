  ...
  return <View style={styles.container}>
            <ScrollView>
                <View style={styles.profileContainer}>
                    <Image source={require("./IMG-20200405-WA0006.jpg")} style={styles.profilePicture} />
                ...
                <View style={[styles.accountHeadings]}>
                    <Text style={styles.inputText1}>Edit </Text>
                    <Text style={[styles.inputText1, styles.EfrhifxF]}>Delete </Text>
                </View>

                <View style={styles.inputs}>
                    <View style={styles.inputContainer}>
                        <Text style={styles.inputText}>First </Text>
                ...
                <Text style={styles.connectAcc}>Connected Peoples</Text>
          ...
          source={require("./assets/btnSigninwithApple.png")} style={styles.dot} />
                        <View>
                            <View style={styles.orderStatusContainer}>
                                <Text style={styles.statusHeading}>Ayema</Text>
          ...
          source={require("./assets/btnSigninwithGoogle.png")} style={styles.dot} />
                        <View>
                            <View style={styles.orderStatusContainer}>
                                <Text style={styles.statusHeading}>Mohit</Text>
                                <Text style={[styles.statusHeading, styles.statusTime]}>Connected</Text>
                            </View>
                        </View>
                    </View>
          ...
          source={require("./assets/btnSigninwithFacebook.png")} style={styles.dot} />
                        <View>
                            <View style={styles.orderStatusContainer}>
                                <Text style={styles.statusHeading}>Deepali</Text>
                                <Text style={[styles.statusHeading, styles.statusTime]}>Connected</Text>
                            </View>
                        </View>
                    </View>
